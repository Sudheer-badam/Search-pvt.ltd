...
const COMPANIES = {
  ...
  "stripe": {
    ...
    timeline: [
      { year: "2010", event: "Founded in Palo Alto by the Collison brothers" },
      { year: "2011", event: "Received investment from Peter Thiel and Elon Musk" },
      { year: "2021", event: "Became the most valuable private company in Silicon Valley" },
      { year: "2024", event: "Expanding into Global Tax and Identity verification" },
    ]
  }
};
